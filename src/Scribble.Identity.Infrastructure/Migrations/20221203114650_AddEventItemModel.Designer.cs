...
namespace Scribble.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20221203114650_AddEventItemModel")]
    partial class AddEventItemModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scribble.Identity.Infrastructure.ApplicationPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scribble.Identity.Infrastructure.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scribble.Identity.Infrastructure.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scribble.Identity.Infrastructure.ApplicationUserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scribble.Identity.Models.EventItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Scribble.Identity.Infrastructure.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Scribble.Identity.Infrastructure.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Scribble.Identity.Infrastructure.ApplicationPermission", b =>
                {
                    b.HasOne("Scribble.Identity.Infrastructure.ApplicationUserProfile", "ApplicationUserProfile")
            ...
            modelBuilder.Entity("Scribble.Identity.Infrastructure.ApplicationUser", b =>
                {
                    b.HasOne("Scribble.Identity.Infrastructure.ApplicationUserProfile", "ApplicationUserProfile")
                        ...
                        .HasForeignKey("Scribble.Identity.Infrastructure.ApplicationUser", "ApplicationUserProfileId");
